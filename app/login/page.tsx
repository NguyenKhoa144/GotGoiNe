  ...
  return (
    ...
    >
      ...
      <div className="mb-6 text-center">
        <p className="mb-1 text-sm font-semibold text-[var(--green-mid)]">Hi bạn! Gọt nè</p>
      ...
      <p className="mt-4 text-center text-sm text-[#4a6e4d]">
        Chưa có tài khoản?{" "}
        <Link href="/register" className="font-semibold text-[var(--green-dark)] transition-colors hover:underline">
          Đăng ký
        </Link>
      </p>
    </form>
